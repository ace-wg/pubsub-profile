...
ToDo: Need to specify N_S generation if we are allowing 
DTLS profile token transfer.
...
- 'key', the keying material for group communication. This is a "COSE\_Key" object (defined in {{I-D.ietf-cose-rfc8152bis-algs}}{{I-D.ietf-cose-rfc8152bis-struct}}, containing:
   ...
   key format MUST register it in the "ACE Groupcomm Key Types" registry including its name, type and application profile to be used with.
